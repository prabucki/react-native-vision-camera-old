...
export interface CameraProps extends ViewProps {
   ...
   *
   * See the [Camera Devices](https://react-native-vision-camera-old.com/docs/guides/devices) section in the documentation for more information about Camera Devices.
   *
   * @example
   * ```tsx
  ...
  device: CameraDevice;
  /**
   * Whether the Camera should actively stream video frames, or not. See the [documentation about the `isActive` prop](https://react-native-vision-camera-old.com/docs/guides/lifecycle#the-isactive-prop) for more information.
   *
  ...
  //#region Use-cases
  /**
   * Enables **photo capture** with the `takePhoto` function (see ["Taking Photos"](https://react-native-vision-camera-old.com/docs/guides/capturing#taking-photos))
   */
  photo?: boolean;
  /**
   * Enables **video capture** with the `startRecording` function (see ["Recording Videos"](https://react-native-vision-camera-old.com/docs/guides/capturing/#recording-videos))
   *
   * Note: If you want to use `video` and `frameProcessor` simultaneously, make sure [`supportsParallelVideoProcessing`](https://react-native-vision-camera-old.com/docs/guides/devices#the-supportsparallelvideoprocessing-prop) is `true`.
   */
  video?: boolean;
  /**
   * Enables **audio capture** for video recordings (see ["Recording Videos"](https://react-native-vision-camera-old.com/docs/guides/capturing/#recording-videos))
   */
  audio?: boolean;
  //#endregion
   ...
   *
   * If you want to implement a custom zoom gesture, see [the Zooming with Reanimated documentation](https://react-native-vision-camera-old.com/docs/guides/animated).
   *
   * @default false
   */
   ...
   *
   * > See [the Frame Processors documentation](https://react-native-vision-camera-old.com/docs/guides/frame-processors) for more information
   *
   * Note: If you want to use `video` and `frameProcessor` simultaneously, make sure [`supportsParallelVideoProcessing`](https://react-native-vision-camera-old.com/docs/guides/devices#the-supportsparallelvideoprocessing-prop) is `true`.
   *
   * @example
