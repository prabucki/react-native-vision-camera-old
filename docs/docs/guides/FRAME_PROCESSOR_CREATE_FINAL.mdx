...
4. Add VisionCamera to `peerDependencies`: `"react-native-vision-camera-old": ">= 2"`
...
8. [Add the plugin to the **official VisionCamera plugin list**](https://github.com/mrousavy/react-native-vision-camera-old/edit/main/docs/docs/guides/FRAME_PROCESSOR_PLUGIN_LIST.mdx) for more visibility
