 ...
 *
 * Read the [VisionCameraOld documentation](https://react-native-vision-camera-old.com/) for more information.
 *
  ...
  private assertFrameProcessorsEnabled(): void {
    ...
    if (global.setFrameProcessor == null || global.unsetFrameProcessor == null) {
      throw new CameraRuntimeError(
        ...
        'Frame Processors are not enabled. See https://react-native-vision-camera-old.com/docs/guides/troubleshooting',
      );
    }
  }
